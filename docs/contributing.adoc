...
= Contributing — pseudoscript
:revdate: 2026-MM-DD

== Audience

Developers working *on* `pseudoscript`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/pseudoscript.git
cd pseudoscript
...
* Bugs in `pseudoscript`: file at `hyperpolymath/pseudoscript/issues`.
